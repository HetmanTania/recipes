    ...
    >
      ...
      <div class="block">
        <div class="single-panels">
          ...
          <div class="features-couisine-clock is-flex is-align-items-center">
            <div
              class="features-block is-flex is-align-items-center is-justify-content-space-between"
            >
              <div>FEATURES:</div>
              <div>
                <img
...
export default {
  ...
  computed: {
    ...
    getDescription() {
      return transformationDescription(this.theRecipe.summary);
    },
  },
  components: {
    Steps,
